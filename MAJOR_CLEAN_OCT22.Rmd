...
-   test if `prepare_and_run_GDM` is still working

    -   problem in analysis_nonpublic.R : masterbeta could not be loaded - connection to server problem? check again later

-   potentially : think about a way to feed desired model names (checklist?)

    probably best solution : not shiny, but make script a function and call from a summary script.

    evaluate : which scripts go to this summary script?
