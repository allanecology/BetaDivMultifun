...
longtable, used 1:1 for lineplot
```{r}
...
lin <- plot_grid(p, biotic_legend, q, labsplot, r, abiotic_legend,  labels = c('A', '', 'B', '', 'C', ''), nrow = 3)
model_name
```
...
# plot pure legend
ov1L <- create_overview_above_below_abiotic_barplot(legend = T)
# plot_grid(NULL, ov1L, ncol = 3)
```
...
# plot pure legend
ov2L <- create_overview_turnover_nestedness_abiotic_barplot(legend = T)
# plot_grid(NULL, ov2L, ncol = 3)
```
