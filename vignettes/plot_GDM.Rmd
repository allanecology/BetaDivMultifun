...
lin_abiotic <- plot_grid(dl, lgeo, lsoil, lisol, labels = c("D", "", "", ""))
...
cowplot::ggsave(plot = lin, filename = paste(pathtoout, "/", model_name, "_lineplot_all_modelspec.pdf", sep = ""),
                device=cairo_pdf, width = 11.96, height = 8.27, units = "in", dpi = 900)
cowplot::ggsave(plot = lin_abiotic, filename = paste(pathtoout, "/", model_name, "_lineplot_all_modelspec_abiotic.pdf", sep = ""),
                device=cairo_pdf, width = 11.96, height = 8.27, units = "in", dpi = 900)
```
...
# ggsave(filename=paste(model_name, "_multipanel_barplot_annotated.pdf", sep = ""), plot = annotated_multipanel_without_overviews, device=cairo_pdf,
       # width = 11.96, height = 8.27, units = "in", dpi = 900)
ggsave(filename = paste(pathtoout, "/", model_name, "_multipanel_barplot_overviewbars_annotated.pdf", sep = ""), plot = annotated_multipanel_with_overview_bars, device=cairo_pdf,
       width = 11.96, height = 8.27, units = "in", dpi = 900)
```
