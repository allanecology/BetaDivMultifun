...
- run `results_nonpublic.R` : load pathtoout, nicenames and model_names
  ...
  - model_names : helper file where all model names are stored, in order to run automatically.
...
```{r}
gdmin <- readRDS(paste_gdm_input_path_together(pathtoout = pathtoout, name = model_name))
