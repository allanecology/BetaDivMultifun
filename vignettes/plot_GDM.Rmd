...
luiinput <- "components" # lui or components
model_name <- "gdm_EFdistance_components"
...
###########
suppressWarnings(
  lin <- plot_grid(p, biotic_legend, q, labsplot, l, abiotic_legend,  labels = c('A', '', 'B', '', 'C', ''), nrow = 3,
...
cowplot::ggsave(plot = lin, filename = paste(model_name, "_lineplot_all_modelspec.pdf", sep = ""),
...
# create sensitivity comparison: deviance explained
```{r, eval = F}
#############################
#
# treshold selection
...
ov1L <- create_overview_above_below_abiotic_barplot(legend = T) # legend only
...
ov2L <- create_overview_turnover_nestedness_abiotic_barplot(legend = T) # only legend
...
# ggsave(filename=paste(model_name, "_multipanel_barplot_annotated.pdf", sep = ""), plot = annotated_multipanel_without_overviews, device=cairo_pdf,
       # width = 11.96, height = 8.27, units = "in", dpi = 900)
ggsave(filename = paste(model_name, "_multipanel_barplot_overviewbars_annotated.pdf", sep = ""), plot = annotated_multipanel_with_overview_bars, device=cairo_pdf,
       width = 11.96, height = 8.27, units = "in", dpi = 900)
```
...
ggsave(filename = "all_legends_incl_overview.pdf", plot = all_legends, device=cairo_pdf,
