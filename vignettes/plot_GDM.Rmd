...
multipanel_with_overview_bars <- plot_grid(p, b, q, ov, 
                                           labels = c('A', '', 'B', 'C'), 
                                             ...
                                             rel_heights = c(0.23, 0.37, 0.15, 0.15), 
...
ggsave(filename = paste(pathtoout, "/", model_name, "_multipanel_barplot_overviewbars.pdf", sep = ""), plot = annotated_multipanel_with_overview_bars, device=cairo_pdf,
       width = 11.96, height = 8.27, units = "in", dpi = 900)
