...
# fill in code to work with significances
...
#TODO change name to "main" --> just one variable name.
```

read input data and produce gdm result
```{r}
gdmin <- readRDS(paste_gdm_input_path_together(pathtoout = pathtoout, name = name))
