...
## historic and landscape LUI

- historic LUI : measure of historic land-use in 1 km radius around the plot
- landscape LUI : % arable land in 1 km radius around the plot. (is more suitable than plot isolation which was used in earlier versions). 
- landscape diversity : number of differnt types and abundances of land-use types. Decide if landscape diversity is taken for analysis.
```{r}
#TODO decide if landscape diversity yes or no
...
landscape <- landscape[, c("Grassland.perm.1000", "Arable.1000", "Shannon.1000")]
```
