...
first convert soil P to stocks rather than concentrations; concentrations are mg/kg, convert to g/g
```{r, eval=F}
nutrients <- list_raw_functions$nutrients

# 2009
assemblednutrients <- merge(raw_functions[,c("Plot", "Biomass2009")], nutrients, by="Plot", all=T) 
assemblednutrients[, Nshoot.2009 := Biomass2009 * (Nshoot.2009 / 100)]
assemblednutrients[, Pshoot.2009 := Biomass2009 * (Pshoot.2010 / 100)]
...
assemblednutrients[, Nshoot.2010 := Biomass2010 * (Nshoot.2010 / 100)]
assemblednutrients[, Pshoot.2010 := Biomass2010 * (Pshoot.2010 / 100)]
# add to raw_functions
...
assemblednutrients[, Nshoot.2011 := Biomass2011 * (Nshoot.2011 / 100)]
assemblednutrients[, Pshoot.2011 := Biomass2011 * (Pshoot.2011 / 100)]
# add to raw_functions
...
assemblednutrients[, Nshoot.2012 := Biomass2012 * (Nshoot.2012 / 100)]
assemblednutrients[, Pshoot.2012 := Biomass2012 * (Pshoot.2012 / 100)]
...
assemblednutrients[, Nshoot.2013 := Biomass2013 * (Nshoot.2013 / 100)]
assemblednutrients[, Pshoot.2013 := Biomass2013 * (Pshoot.2013 / 100)]
...
#TODO : delete this chapter? Pshoot and Nshoot are only used for PRI and NRI, right? They can be read in from list_raw_functions$nutrients
```
