...
#TODO : test adding to raw_functions (last line)
#TODO : proofread

pat <- list_raw_functions[["pathogen.infection"]]
npla <- list_raw_functions[["plantcover"]]
...
raw_functions <- merge(raw_functions, pathogen.infection, by="Plot", all=T) ; rm(dung.decomposition)
```
