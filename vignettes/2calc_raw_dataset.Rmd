...
#TODO : multiply with biomass from same year
...
#TODO : exchange bulk density with the 2014 one as soon as I get it.
rPRI <- raw_functions[, c("Plot", "Pmic.2014", "Bulk.density2011", "OlsenPi2014", "Pshoot.2013", "Biomass2013")]
rPRI[, "micPstock":= (Pmic.2014 / 1000000)*(Bulk.density2011 * 100000)]
rPRI[, "soilPstock" := (OlsenPi2014 / 1000000) * (Bulk.density2011 * 100000)]
...
# dividemean
plantcover[, "divnormCover" := Cover / mean(plantcover$areaCover)]
# standardisation
plantcover[, "standCover" := scale(Cover)]
...
d <- merge(pathogen.infection, synthesis[, c("Plot", "pathogen.infection")], by="Plot")
