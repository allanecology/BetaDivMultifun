...
nutrients <- nutrients[, c("Plot", "Pshoot2014percent")]
nutrients <- nutrients[, Pshoot2014percent := Pshoot2014percent/100]
...
rPRI[, "plantPstock" := Pshoot2014percent * Biomass2014]
...
Nshoot.2014 <- Nshoot.2014[, c("Plot", "Nshoot2014percent")]
# convert to stocks rather than concentrations; concentrations are mg/kg, convert to g/g
Nshoot.2014[, Nshoot2014percent :=  Nshoot2014percent/100]
nridat <- merge(nridat, Nshoot.2014, by="Plot", all = T)
...
nridat[, "plantNstock" := Nshoot2014percent * Biomass2014]
