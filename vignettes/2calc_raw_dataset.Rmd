...
nridat <- raw_functions[,c("Plot", "Bulk.density2014", "NH4.2014", "NO3.2014", "Biomass2013", "Nmic.2014")]
Nshoot.2013 <- list_raw_functions$nutrients
Nshoot.2013 <- Nshoot.2013[, c("Plot", "Nshoot2013percent")]
nridat <- merge(nridat, Nshoot.2013, by="Plot", all = T)
...
nridat[, "plantNstock" := Nshoot2013percent * Biomass2013]
