...
---
# Dependence
This document depends on `1read_raw_datasets.Rmd`.
...
TODO : change : first, mean, then scale
```{r}
Gtot[, "unscaled_mean" := apply(.SD, 1, mean), .SDcols = c("2010", "2011", "2012", "2013", "2014", "2015", "2016")]
# scd <- cbind(Gtot[,c("Plot")], apply(Gtot[, c("2010", "2011", "2012", "2013", "2014", "2015", "2016")], 2, scale))
# raw_functions[, "Groundwater.recharge" := rowMeans(scd[, c("2010", "2011", "2012", "2013", "2014", "2015", "2016")])]
raw_functions[, "Groundwater.recharge" := apply(Gtot[, unscaled_mean], 2, scale)]
rm(Gtot); rm(scd)
...
write.table(raw_functions, file=paste("", prefix, "_raw_functions_dataset.csv", sep=""), sep=";")
rm(prefix)
```
