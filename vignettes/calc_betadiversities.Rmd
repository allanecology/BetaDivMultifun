...
TODO : combine for the moment, but keep in mind that snails could be taken out as well to have more plots --> keep both datasets
```{r}
...
Select 2011 dataset.
```{r}
bacteriaRNA <- bacteriaRNA[Year == "2011"]
nrow(bacteriaRNA) == 148 * 140510
#TODO HERE : why is this not the same number as expected??
# are there some plot-species combinations not present in the dataset?
```
...
Maybe the appendix protist24466 and protist24426 are causing the problem?
```{r}
#TODO : remove some rows when new dataset is there.
protist_bacterivore[grep("_protist24466", Species), Species := gsub("_protist24466", "", Species)]
protist_bacterivore[grep("_protist18206", Species), Species := gsub("_protist18206", "", Species)]
protist_bacterivore[grep("_protist24426", Species), Species := gsub("_protist24426", "", Species)]
protist_bacterivore[grep("_protist18166", Species), Species := gsub("_protist18166", "", Species)]
protist_bacterivore[grep("_protist18187", Species), Species := gsub("_protist18187", "", Species)]
protist_bacterivore[grep("_protist18226", Species), Species := gsub("_protist18226", "", Species)]
protist_bacterivore[grep("_protist18207", Species), Species := gsub("_protist18207", "", Species)]
protist_bacterivore[grep("_protist18208", Species), Species := gsub("_protist18208", "", Species)]
