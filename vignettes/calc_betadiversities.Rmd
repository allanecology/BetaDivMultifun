...
symbiont.soilfungi <- add_back_missing_plots_species_combinations(symbiont.soilfungi)
length(unique(symbiont.soilfungi$Plot))
...
plantpathogen.fungi <- add_back_missing_plots_species_combinations(plantpathogen.fungi)
```
```{r}
...
common.plots <- Reduce(intersect,plots) #130 plots, new : 124 plots
