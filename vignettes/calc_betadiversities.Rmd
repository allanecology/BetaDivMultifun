...
spdiv <- spdiv[!Trophic_level %in% c("detritivore", "unknown.protist", "unknown.soilfungi", "unknown.acari", "vert.herb", "protist.parasite.nonplant")]
# take out trophic levels which were excluded during this analysis
# OPTION : comment out to reproduce reason of exclusion
exclude <- c("pollinator", "pollinator.arthropod", "decomposer.acari", "decomposer.arthropod", "decomposer.myriapod", "decomposer.soilfungi", "omnivore.arthropod", "omnivore.protist", "omnivore")
