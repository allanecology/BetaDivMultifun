...
- Hymenoptera was only assessed in 1 year, plus many missing plots --> exclude
...
Snails are only from 1 year, and 16 plots are missing, all in one of the exploratories. We can not include them.
...
barplot(redplotset, ylim = c(0, 150), las = 3, cex.names = 0.8, main = "Does removal of given trophic level increase number of plots?")
# abline(h = 114, col = "darkgreen")
abline(h = 147, col = "red")

length(grep("AEG", common.plots)) # 48
length(grep("HEG", common.plots)) # 50
length(grep("SEG", common.plots)) # 49

#TODO : assign plotNAset newly! for the moment : assign by hand : (October 23)
...
[1] "    Number of group broad :  1  groups :  Protists"
[1] "herbivore.arthropod :  651 species."
[1] "    Number of group broad :  5  groups :  NA, Hemiptera, Coleoptera, Hymenoptera, Orthoptera"
...
[1] "    Number of group broad :  1  groups :  Insect.larvae"
[1] "symbiont.soilfungi :  328 species."
[1] "    Number of group broad :  2  groups :  NA, soilfungi"
[1] "tertiary.consumer :  67 species."
[1] "    Number of group broad :  1  groups :  Birds"
[1] "secondary.consumer :  343 species."
[1] "    Number of group broad :  6  groups :  NA, Coleoptera, Araneae, Hemiptera, Orthoptera, Myriapoda"
[1] "decomposer :  130 species."
[1] "    Number of group broad :  3  groups :  NA, Coleoptera, Myriapoda"

Total : 146'885 species in the  dataset (6'375 species without bacteria) belonging to 16 broad taxonomic groups
...
Rarefaction of bacteria and soilfungi datasets TODO 
need to do??
```{r, eval = F}
...
# Cleaning
```{r}
rm(spdiv); rm(test); rm(redplotset); rm(plots)
