...
# bacteria.RNA <- add_back_missing_plots_species_combinations(bacteria.RNA) # 23276560 missing combinations were added.
...
bacteria.RNA <- add_back_missing_plots_species_combinations(bacteria.RNA) # 19052152 missing combinations were added.
...
plant.pathogen <- add_back_missing_plots_species_combinations(plant.pathogen)
```
```{r}
...
```
84 species in 144 plots
```{r}
length(unique(plantpathogen.fungi$Plot))
nrow(plantpathogen.fungi) == 84 * 144
