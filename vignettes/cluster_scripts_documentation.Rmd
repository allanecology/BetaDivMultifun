...
---
# Cluster
In order to run R code on the cluster of the University of Bern, please follow the instructions on the [UBELIX help page](https://hpc-unibe-ch.github.io//). There is a great documentation (also about using R on the cluster).
- get user profile
...
# Data
model results need to be uploaded : <modelname>_input.Rds files which contain site-pair tables, as used for gdm models.
```{bash}
...
- EFturnover 0.8 and EFturnover 0.9, failed directly or took longer than 1h.
