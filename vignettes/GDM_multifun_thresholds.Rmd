...
# ispline_uncertainty_all_threshoslds <- fread(paste0(pathtodata, "/analysis/output_datasets/uncertainty_calc/allmod_LUI_uncertainty_weighted_avg.csv"))
...
##### overview bars
```{r}
#TODO HERE create barplots, and overviewbars of those models.
# use old code
```
