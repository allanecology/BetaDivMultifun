...
Content
- **Threshold selection** : produce plots that show that a selection of a given threshold is impossible
...
# Threshold selection
Produce plots that show that a selection of a given threshold is impossible.
...
# is the response variable of all the models
...
#TODO where is this? Can be produced by a new script : summarise_resuls??
#TODO renamed to GDM_results, and is not produced by the script "summarise_GDM_results.Rmd"
...
# hack to use oritinal code : rename the according column in the data.table restab
