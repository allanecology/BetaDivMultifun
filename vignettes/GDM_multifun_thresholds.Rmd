...
## barplot average effects over all thresholds DEPRECIATED
*Note : *The preferred dataset is weighted average over all thresholds, so don't run the below piece of code.
#TODO : delete this part of the script
...
# save
###########
ggsave(filename = paste(pathtoout, "/", model_name, "_multipanel_barplot_overviewbars_not_annotated.pdf", sep = ""), plot = multipanel_with_overview_bars, device=cairo_pdf,
       width = 11.96, height = 8.27, units = "in", dpi = 900)
