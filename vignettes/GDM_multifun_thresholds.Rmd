...
gdm::plotUncertainty(gdminput, sampleSites = 0.3, bsIters = 4, geo=T, splineCol = "black", cores = 2)
dev.off()

test <- plotUncertainty_getsd(gdminput, sampleSites = 0.3, bsIters = 10, geo = T, splineCol = "black", cores = 2)
# do for each threshold

# /home/novalid/IPS_SYNCFILES_BetaDivMultifun/analysis/output_datasets/uncertainty_calc
