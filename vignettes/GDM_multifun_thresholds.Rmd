...
restab <- merge(gdm_EFturnover_0.1_LUI, gdm_EFturnover_0.2_LUI, by = "varname", suffixes = c("_to_0.1", "_to_0.2"))
restab <- merge(restab,  gdm_EFturnover_0.3_LUI, by = "varname")
restab <- merge(restab,  gdm_EFturnover_0.4_LUI, by = "varname", suffixes = c("_to_0.3", "_to_0.4"))
restab <- merge(restab,  gdm_EFturnover_0.5_LUI, by = "varname")
restab <- merge(restab,  gdm_EFturnover_0.6_LUI, by = "varname", suffixes = c("_to_0.5", "_to_0.6"))
restab <- merge(restab,  gdm_EFturnover_0.7_LUI, by = "varname")
restab <- merge(restab,  gdm_EFturnover_0.8_LUI, by = "varname", suffixes = c("_to_0.7", "_to_0.8"))
restab <- merge(restab,  gdm_EFturnover_0.9_LUI, by = "varname")
setnames(restab, old = c("yatmax", "sdy"), new = paste(c("yatmax", "sdy"), "_to_0.9", sep = ""))
```
