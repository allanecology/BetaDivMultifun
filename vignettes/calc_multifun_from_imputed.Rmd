...
#TODO is that used somewhere? if not, delete
```
...
for(f in usedforBetadivMultifun[!usedforBetadivMultifun == "Plotn"]){
  ...
  diffsmall[, eval(f) := scale(X, center = T, scale = T)] # scale and center
  #TODO remove scaling here, below normalisation is done
  diffsmall[, X := NULL]
...
**axis selection** : 
- 9 correlations > 0.5
    - 6 clusters of inter-correlated functions
- 17 PC axes (17 functions)
- 17-6 = 11 axes
- 11 axes explain 0.91620 % var
- take first 11 axes
