...
---
requires `analysis_nonpublic.R` to load soil covariates
...
*This is a "human" classification, not a "pure physical". Based on which informations? Do we add some "false" information with that, which is then left in the data as only the overlapping information is "removed" in the PCA?*
