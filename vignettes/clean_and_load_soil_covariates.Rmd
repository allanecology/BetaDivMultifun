...
## Plot selection
plots could be selected here, but it is better to exclude them in the subsequent scripts, because the imputation script is based on a version of glsoil including "HEG31", but the covariate calculation script is not.
```{r, eval=F}
