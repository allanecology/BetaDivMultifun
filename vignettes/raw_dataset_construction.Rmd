...
```{r, eval=F}
pathogen.infection <- data.table::fread(info_data$path_unix[grep("pathogen.infection", info_data$ColumnName)])
...
# TODO find 2011 plant cover data to calc pathogen infection
# TODO add raw data to calc path infection to list_raw_functions
