...
raw_functions <- merge(raw_functions, Biomass2013, by="Plot")
...
raw_functions <- merge(raw_functions, Biomass2016, by="Plot")
...
raw_functions <- merge(raw_functions, Biomass2017, by="Plot", all=T)
...
list_raw_functions[["Root.biomass"]] <- Root.biomass
```
...
list_raw_functions[["Herbivory.2013"]] <- herb
```
...
raw_functions <- merge(raw_functions, Potential.nitrification, by="Plot")
```
...
raw_functions <- merge(raw_functions, Nmic.2011, by="Plot")
```
...
raw_functions <- merge(raw_functions, mAMFhyphae, by="Plot", all.x = T, all.y = T)
```
...
list_raw_functions[["Groundwater.recharge"]] <- Gtot
...
list_raw_functions[["Litter.decomposition"]] <- Litter.decomposition
```
...
list_raw_functions[["Parasitoid.traps"]] <- Parasitoid.traps
```
...
list_raw_functions[["pathogen.infection"]] <- pathogen.infection
list_raw_functions[["pathogen.infection2"]] <- pathogen.infection2
```
...
list_raw_functions[["Total.pollinators"]] <- Total.pollinators
```
