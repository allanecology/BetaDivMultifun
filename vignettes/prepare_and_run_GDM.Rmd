...
```{r}
#TODO : write automatic input for all models : if calling from a summary script : 
#    put a default value here, in case none is given.
...
if(exists("model_names_selection")){
  ...
  print("model selection is done by hand, default is EFturnover_0.7")
