...
*CAUTION* this automated workflow currently only works for UNIX Systems. This is because paths are specified in LINUX way (using "/" and not "\\" which is used under Windows. and OSX)
will be changed at one point.