...
```{r}
# nitrate.production.availability (inverted DEA)
mindea <- min(befun$nitrate.production.availability, na.rm=T)
befun$nitrate.production.availability <- befun$nitrate.production.availability + abs(mindea)
# NO3.2014
...
for(i in 1:50){
  ...
  current$nitrate.production.availability <- current$nitrate.production.availability - abs(mindea)
