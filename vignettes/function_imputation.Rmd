...
rm(befun); rm(befunbackup); rm(impvals); rm(corrbefun); rm(dataset); rm(imperr); rm(impvals)
rm(X); rm(Y); rm(p); rm(naloc); rm(mimperr)
rm(i); rm(colname); rm(mindea); rm(mindung); rm(minno)
rm(rowlocations); rm(numcols); rm(x); rm(y); rm(tres)
```
