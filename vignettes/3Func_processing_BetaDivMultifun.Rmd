...
min(apply(befun, 2, function(x) min(x, na.rm=T)))
```
There are no negative values
#TODO : yes there are ! dung decomposition!!

## Imputation
```{r}
imp <- missForest::missForest(befun[, !colnames(befun) %in% "Plotn", with=F])
#TODO still fukinbaaad because negative vals.
```
