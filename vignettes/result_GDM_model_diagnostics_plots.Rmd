...
Quick and dirty diagnostics plot function. Adapted from gdm package: just plot first 2 plots. (In package, there was no possibility to plot only the first 2 plots).
```{r, include = F}
#TODO : add to package!
