...
## Arable or Shannon/Land.te

We know from study https://doi.org/10.1038/s41467-021-23931-1 that % arable land is correlated with landscape LUI.

Diversity of landscape use and total edge are correlated. Makes sense because the more diverse land-uses are present in a landscape, the more edges we can observe. Is not completely the same tough: total edge measures landcape fragmentation, the diversity measures the number and abundance of land-uses at the lanscape scale.
