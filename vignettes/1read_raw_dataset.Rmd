...
# Root biomass
2011, Includes fine and coarse biomass, will add them together.
```{r}
...
note : Olsen Pi is better suited than NaHCO3_Pi, because olsen measurese the plant available P only.
```{r}
...
```{r, eval=F}
data.table::fread("/run/user/1001/gvfs/smb-share:server=ipssmonstera.unibe.ch,share=planteco/DATA/BE_Synthesis/BetaDivMultifun/raw_data/20251_Microbial soil properties of all grassland EPs, soil sampling campaign (SSC) 2014, SCALEMIC_1.2.13/20251.txt")
...
# Forage quality - NOT Calculated
Was not used, therefore not calculated and not read in.
...
Olsen method, measures P available to plants.
```{r}
