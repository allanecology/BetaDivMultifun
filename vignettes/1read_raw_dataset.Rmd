...
Easiest : 
- only summer 2014 (month must contain 2014)
just add up the removal_g per plot and divide by number of contributors
```{r, eval=F}
...
aug <- dung.decomposition[month == "August_2014"]
#TODO : check in which month all plots were measured equally often.
barplot(table(dung.decomposition$EP))

p <- ggplot(dung.decomposition, aes(x=EP)) + 
  geom_density()
```
