...
EFmaster$EFdistance <- new
    # or single functions
#TODO : HERE : scale single functions as well! scale all but the first 2 columsn (which contain plots).
# und bei der gelegenheit - gleich ins richtige skript schieben
```
